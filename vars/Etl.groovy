      ...
      steps {
        ...
        script {
            ...
            sh '''
               ...
               ssh -o StrictHostKeyChecking=no ansible@ansible1.data.int.dc1.ad.net docker cp common/airflow/amazon_associate_etl_config.json eeb82e397165:/opt/airflow/dags
